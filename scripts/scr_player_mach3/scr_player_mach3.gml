function scr_player_mach3() {
	...
	if (((!key_attack) && fightball == 0 && grounded && (character == "P" or character == "N")) or (character == "S" && (move == 0 or move != xscale) && grounded && fightball == 0))
	{
	...
	if (move == (-xscale) && grounded && (character == "P" or character == "N") && fightball == 0)
	{
	...
	if (((!grounded) && place_meeting((x + hsp), y, obj_solid) && (!(place_meeting((x + hsp), y, obj_destructibles))) && (!(place_meeting((x + hsp), y, obj_metalblock))) && (!(place_meeting((x + sign(hsp)), y, obj_slope)))) or (grounded && place_meeting((x + hsp), (y - 32), obj_solid) && (!(place_meeting((x + hsp), y, obj_destructibles))) && (!(place_meeting((x + hsp), y, obj_metalblock))) && place_meeting(x, (y + 1), obj_slope)))
	{
		wallspeed = movespeed
		state = states.climbwall
	}
	if (scr_solid((x + 1), y) && xscale == 1 && (!scr_slope()) && (!(place_meeting((x + sign(hsp)), y, obj_slope))) && (!(place_meeting((x + sign(hsp)), y, obj_metalblock))) && (!(place_meeting((x + sign(hsp)), y, obj_destructibles))) && (grounded or fightball == 1))
	{
		if (fightball == 0)
		{
