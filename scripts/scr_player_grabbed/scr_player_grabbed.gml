	...
	switch object_index
	{
		case obj_player2:
			...
			with (obj_player1)
			{
				...
				if (!((state == states.grab or (state == states.mach3 && fightball == 1) or state == states.finishingblow or state == states.grabbing or state == states._throw or state == states.slam or state == states.tacklecharge or state == states.punch or state == states.superslam or state == states.backkick or state == states.uppunch or state == states.shoulder)))
				{
					other.x = x
					other.y = y
