function scr_player_Sjumpprep() {
	...
	if (floor(image_index) == (image_number - 1) && sprite_index == spr_superjumpprep)
		sprite_index = spr_superjumppreplight
	if ((!key_up) && (character == "S" or sprite_index == spr_superjumppreplight or sprite_index == spr_superjumpleft or sprite_index == spr_superjumpright) && (!(scr_solid(x, (y - 16)))) && (!(scr_solid(x, (y - 32)))))
	{
