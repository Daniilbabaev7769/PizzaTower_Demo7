function scr_player_cheesepep() {
	...
	if ((floor(image_index) == (image_number - 1) && sprite_index == spr_cheesepep_jump) or ((!grounded) && sprite_index != spr_cheesepep_jump) or (vsp > 0 && sprite_index == spr_cheesepep_jump))
