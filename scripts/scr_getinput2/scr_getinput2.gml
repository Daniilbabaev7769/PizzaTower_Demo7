function scr_getinput2(){
	...
	key_up2 = (keyboard_check_pressed(global.key_upN) or gamepad_button_check_pressed(1, global.key_upCN) or (gamepad_axis_value(1, gp_axislv) < -0.5 && stickpressed == 0))
	...
	key_right2 = (keyboard_check_pressed(global.key_rightN) or gamepad_button_check_pressed(1, global.key_rightCN) or (gamepad_axis_value(1, gp_axislh) > 0.5 && stickpressed == 0))
	key_left = (-((keyboard_check(global.key_leftN) or gamepad_button_check(1, global.key_leftCN) or gamepad_axis_value(1, gp_axislh) < 0)))
	key_left2 = (-((keyboard_check_pressed(global.key_leftN) or gamepad_button_check_pressed(1, global.key_leftCN) or (gamepad_axis_value(1, gp_axislh) < -0.5 && stickpressed == 0))))
	key_down = (keyboard_check(global.key_downN) or gamepad_button_check(1, global.key_downCN) or gamepad_axis_value(1, gp_axislv) > 0)
	key_down2 = (keyboard_check_pressed(global.key_downN) or gamepad_button_check_pressed(1, global.key_downCN) or (gamepad_axis_value(1, gp_axislv) > 0.5 && stickpressed == 0))
	...
	if (gamepad_axis_value(1, gp_axislh) > 0.5 or gamepad_axis_value(1, gp_axislh) < -0.5 or gamepad_axis_value(1, gp_axislv) > 0.5 or gamepad_axis_value(1, gp_axislv) < -0.5)
		stickpressed = 1
	else
		stickpressed = 0
}
