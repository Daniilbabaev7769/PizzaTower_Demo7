...
if (player == 0)
{
	...
	if (key_select == 8)
		draw_text_colour(420, 450, string_hash_to_newline("TAUNT"), c_white, c_white, c_white, c_white, 1)
	else
		draw_text_colour(420, 450, string_hash_to_newline("TAUNT"), c_white, c_white, c_white, c_white, 0.5)
	draw_text(580, 450, string_hash_to_newline(scr_keyname(global.key_taunt)))
	if (key_select == 9)
		draw_text_colour(420, 500, string_hash_to_newline("PAUSE"), c_white, c_white, c_white, c_white, 1)
	else
		draw_text_colour(420, 500, string_hash_to_newline("PAUSE"), c_white, c_white, c_white, c_white, 0.5)
