if (global.panic == 0 && global.snickchallenge == 0)
{
	...
	if (string_letters(roomname) == "minigolf")
	{
	...
	if (string_letters(roomname) == "chateausecret" or string_letters(roomname) == "strongcoldsecret" or string_letters(roomname) == "medievalsecret" or string_letters(roomname) == "ruinsecret" or string_letters(roomname) == "dungeonsecret")
	{
