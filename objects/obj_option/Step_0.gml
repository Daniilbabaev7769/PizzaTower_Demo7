...
if (optionselected == 0)
{
	...
	if ((obj_player.key_jump or keyboard_check_pressed(vk_return)) && optionsaved_fullscreen == 0)
	{
	...
	if (obj_player.key_jump or keyboard_check_pressed(vk_return) && optionsaved_fullscreen == 1)
	{
...
if (optionselected == 1)
{
	...
	if (((-obj_player.key_left2) or keyboard_check_pressed(vk_left)) && optionsaved_resolution > 0)
		optionsaved_resolution -= 1
	if ((obj_player.key_jump or keyboard_check_pressed(vk_return)) && optionsaved_resolution == 0)
	{
		ini_open("saveData.ini")
	...
	if ((obj_player.key_jump or keyboard_check_pressed(vk_return)) && optionsaved_resolution == 1)
	{
	...
	if ((obj_player.key_jump or keyboard_check_pressed(vk_return)) && optionsaved_resolution == 2)
	{
...
if (optionselected == 2)
{
	if (!instance_exists(obj_keyconfig))
	{
		if (obj_player.key_jump or keyboard_check_pressed(vk_return) or keyboard_check_pressed(vk_return))
		{
			visible = false
